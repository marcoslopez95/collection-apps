...
import 'package:access_maketicket/workingApps/chatGPT/components/commonIconButton.dart';
import 'package:access_maketicket/workingApps/chatGPT/components/voice_search_component.dart';
import 'package:access_maketicket/workingApps/chatGPT/models/question_answer_model.dart';
import 'package:access_maketicket/workingApps/chatGPT/screens/empty_screen.dart';
      ...
      body: Stack(
        ...
        children: [
          ...
          Container(
            ...
            width: context.width(),
            margin: EdgeInsets.only(bottom: 66 + ( 0) + (isShowOption ? 50 : 0)),
