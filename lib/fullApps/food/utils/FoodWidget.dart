...
import 'package:access_maketicket/fullApps/food/screen/FoodAddAddress.dart';
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(height: 0.5, color: food_view_color, width: context.width(), margin: EdgeInsets.only(top: 16, bottom: 16)),
                GestureDetector(
                  onTap: () {
