  ...
  Widget build(BuildContext context) {
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  8.height,
                  AppButton(
                    text: BHTxtGoAppointment,
                    width: context.width(),
                    textStyle: TextStyle(color: BHColorPrimary, fontSize: 15, fontWeight: FontWeight.bold),
                    color: context.cardColor,
                    onTap: () {},
                  ),
                ],
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Theme(
          data: ThemeData(colorScheme: ColorScheme.fromSwatch(primarySwatch: MaterialColor(0xFFff6e40, color)).copyWith(background: redColor)),
          child: Stepper(
