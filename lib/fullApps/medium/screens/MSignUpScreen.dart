...
import 'package:access_maketicket/fullApps/medium/screens/MSelectTopicScreen.dart';
import 'package:access_maketicket/fullApps/medium/utils/MColors.dart';
import 'package:access_maketicket/fullApps/medium/utils/MConstants.dart';
...
class MSignUpScreenState extends State<MSignUpScreen> {
  ...
  Widget build(BuildContext context) {
    Widget commonButton({required String title, required String icon, Function? onTap}) {
      ...
      ).onTap(onTap,splashColor: Colors.transparent,hoverColor: Colors.transparent,highlightColor: Colors.transparent);
    }
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      8.width,
                      Image.asset(MIconEmail, height: 30, width: 30, color: white,fit: BoxFit.cover),
                      16.width,
