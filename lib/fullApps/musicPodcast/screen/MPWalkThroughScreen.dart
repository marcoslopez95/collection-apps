    ...
    pages = [
      ...
      Column(
        ...
        children: [
          ...
          8.height,
          Text('ProKit – Biggest Flutter UI kit is the ultimate \n library of Flutter UI templates.', style: secondaryTextStyle(color: Colors.white), textAlign: TextAlign.center)
        ],
      ),
      Column(
        mainAxisAlignment: MainAxisAlignment.center,
