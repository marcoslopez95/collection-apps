...
List<WAWalkThroughModel> waWalkThroughList() {
  ...
  list.add(WAWalkThroughModel(
      ...
      description: ProKitShortText,
      image: 'images/walletApp/wa_walkthorugh.png'));
  list.add(WAWalkThroughModel(
      title: "Mange Anytime",
      description: ProKitLongText,
      image: 'images/walletApp/wa_walkthorugh.png'));
  list.add(WAWalkThroughModel(
...
List<WARecentPayeesModel> waRecentPayeesList() {
  ...
  list.add(WARecentPayeesModel(image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIuNPlLLXKdjlBivtZzQxsq-hW9E6YbooFXqDqST7AfuSHGcN45DIDTi5qeLOQHNrNR9g&usqp=CAU', name: 'John', number: '123456789'));
  list.add(WARecentPayeesModel(image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIuNPlLLXKdjlBivtZzQxsq-hW9E6YbooFXqDqST7AfuSHGcN45DIDTi5qeLOQHNrNR9g&usqp=CAU', name: 'Rose', number: '78571237'));
...
List<WAWalletUserModel> waWalletUserList() {
  ...
  list.add(WAWalletUserModel(image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSB8vuaWT6wGaoDz6T0UEilQ8wwcFO-hvserEgijbpPulSLBBpgbkxZBjwhUsU3ULuPazM&usqp=CAU"));
