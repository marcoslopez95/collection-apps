    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          StaggeredGrid.count(
            crossAxisCount: 2,
            children: mlProfileData.map((mlProfileData) {
              return Container(
                padding: EdgeInsets.all(16),
                decoration: boxDecorationWithRoundedCorners(backgroundColor: mlProfileData.color!),
                child: Column(
                ...
                () {
                  toasty(context, mlProfileData.name);
                },
              );
            }).toList(),
