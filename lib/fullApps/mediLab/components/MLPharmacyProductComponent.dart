...
import 'package:access_maketicket/fullApps/mediLab/screens/MLProductDetailScreen.dart';
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  8.height,
                  Text((data.title).validate(), style: boldTextStyle()).paddingOnly(left: 10, right: 10),
                  2.height,
