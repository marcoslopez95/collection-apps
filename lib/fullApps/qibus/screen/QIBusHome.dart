...
import 'package:access_maketicket/fullApps/qibus/screen/QIBusNotification.dart';
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          ElevatedButton(
              ...
              child: Container(
                decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(8.0)), color: qIBus_colorPrimary),
                child: Center(
                  child: Padding(
                    padding: EdgeInsets.all(16.0),
                    child: Text(
