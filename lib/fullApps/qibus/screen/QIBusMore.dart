                            ...
                            children: [
                              WidgetSpan(
                                child: Padding(
                                  ...
                                  child: SvgPicture.asset(qibus_ic_logout, color: appStore.isDarkModeOn ? white : qIBus_textHeader, height: 18, width: 18),
                                ),
                              ),
                              TextSpan(
                                text: QIBus_text_logout,
                                style: TextStyle(fontSize: textSizeMedium, color: appStore.isDarkModeOn ? white : qIBus_textHeader),
                              ),
                            ],
                          ),
                        ),
