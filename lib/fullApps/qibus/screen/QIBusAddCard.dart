...
import 'package:access_maketicket/fullApps/qibus/utils/QiBusWidget.dart';
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          Expanded(child: pinEditTextStyle("4324")),
                          Expanded(child: pinEditTextStyle("4324")),
                          Expanded(child: pinEditTextStyle("4324")),
                          Expanded(child: pinEditTextStyle("4324")),
                        ],
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                Expanded(child: text(QIBus_text_pickup_point, fontFamily: fontMedium), flex: 2),
                                Expanded(child: text(QIBus_lbl_pickup1, textColor: qIBus_textChild), flex: 2)
                              ],
                            ),
                            SizedBox(height: spacing_standard),
                            Row(
                              children: <Widget>[
                                Expanded(child: text(QIBus_text_dropping_points, fontFamily: fontMedium), flex: 2),
                                Expanded(child: text(QIBus_lbl_dropping1, textColor: qIBus_textChild), flex: 2)
                              ],
                            ),
                            SizedBox(height: spacing_standard),
                            Row(
                              children: <Widget>[
                                Expanded(child: text(QIBus_text_total_amount, fontFamily: fontMedium, textColor: qIBus_colorPrimary), flex: 2),
                                Expanded(child: text(QIBus_lbl_price1, textColor: qIBus_colorPrimary), flex: 2)
                              ],
                            )
                          ],
                        ),
