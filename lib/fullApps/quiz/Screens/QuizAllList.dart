            ...
            children: <Widget>[
              ClipRRect(
                ...
                child: CachedNetworkImage(
                  ...
                  imageUrl: mListingsData.quizImage,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    text(mListingsData.quizName, fontSize: textSizeMedium, maxLine: 2, fontFamily: fontMedium).paddingOnly(top: 8, left: 16, right: 16, bottom: 8),
                    text(mListingsData.totalQuiz, textColor: quiz_textColorSecondary).paddingOnly(left: 16, right: 16, bottom: 8),
                  ],
                ),
              ),
            ],
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    text(mListingsData.quizName, fontSize: textSizeMedium, maxLine: 2, fontFamily: fontMedium).paddingOnly(top: 8, left: 16, right: 16, bottom: 8),
                    text(mListingsData.totalQuiz, textColor: quiz_textColorSecondary).paddingOnly(left: 16, right: 16, bottom: 16),
