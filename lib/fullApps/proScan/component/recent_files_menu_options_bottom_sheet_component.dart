...
import 'package:access_maketicket/fullApps/proScan/component/rename_bottom_sheet_component.dart';
import 'package:access_maketicket/fullApps/proScan/screens/merge_pdf_screen.dart';
import 'package:access_maketicket/fullApps/proScan/screens/protect_pdf_screen.dart';
...
Future<dynamic> RecentFilesMenuOptionsBottomSheet(BuildContext context, double height, double width, int listIndex, {String? cardTitleText, String? date, String? time, String? cardImage}) {
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(color: appStore.isDarkModeOn ? proScanDarkPrimaryColor : Colors.grey.shade200, borderRadius: BorderRadius.circular(PRO_SCAN_DEFAULT_RADIUS)),
                    child: Row(
                      children: [
                        Container(
                          height: height * 0.13,
                  ...
                  GestureDetector(
                    ...
                    child: ListTile(
                      ...
                      leading: Image.asset(
                        "images/proScan/icons/dashboard_icons/save.png",
                        height: 20,
                  ...
                  GestureDetector(
                    ...
                    child: ListTile(
                      ...
                      leading: Image.asset(
                        "images/proScan/icons/dashboard_icons/export.png",
                        height: 20,
                        color: appStore.isDarkModeOn ? Colors.white : Colors.black,
                      ),
                      trailing: Icon(
