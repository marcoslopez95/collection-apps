...
import 'package:access_maketicket/fullApps/proScan/screens/select_payment_screen.dart';
                  ...
                  AppButton(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SelectPaymentScreen(amount: premiumOptionList[index].amount.toString(), months: premiumOptionList[index].months.toString()),
                        ),
                      );
                    },
                    color: Colors.white,
