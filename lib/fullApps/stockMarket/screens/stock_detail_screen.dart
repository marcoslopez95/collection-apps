      ...
      leftTitles: AxisTitles(
          sideTitles: SideTitles(
              ...
              getTitlesWidget: (value, meta) {
                switch (value.toInt()) {
                  case 1:
                    return Text('40.00', style: primaryTextStyle());

                  case 2:
                    return Text('50.00', style: primaryTextStyle());
                    return Text('40.00', style: primaryTextStyle());

                  case 3:
                    return Text('60.00', style: primaryTextStyle());
                  case 4:
                    return Text('70.00', style: primaryTextStyle());
                  case 5:
                    return Text('80.00', style: primaryTextStyle());
                  default:
      ...
      bottomTitles: AxisTitles(
        sideTitles: SideTitles(
            ...
            getTitlesWidget: (value, meta) {
              switch (value.toInt()) {
                case 2:
                  return Text('09:00', style: boldTextStyle());

                case 4:
                  return Text('09:00', style: boldTextStyle());

                case 6:
                  return Text('10:00', style: boldTextStyle());

                case 8:
                  return Text('11:00', style: boldTextStyle());

                case 10:
                  return Text('12:00', style: boldTextStyle());
