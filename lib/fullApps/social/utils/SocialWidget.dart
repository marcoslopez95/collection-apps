...
class SocialAppButtonState extends State<SocialAppButton> {
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      ...
      child: Container(
        decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(8.0)), color: social_colorPrimary),
        child: Center(
          child: Padding(
            ...
            child: RichText(
              text: TextSpan(
                children: [
                  TextSpan(text: widget.textContent, style: TextStyle(fontSize: textSizeMedium,color: white)),
                  WidgetSpan(
                    child: Padding(padding: EdgeInsets.symmetric(horizontal: 8.0), child: Icon(Icons.arrow_forward, color: social_white, size: 16)),
                  ),
                ],
              ),
            ),
