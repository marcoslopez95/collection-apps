              ...
              child: Container(
                ...
                child: IconButton(
                  ...
                  icon: !categorymodal[index].isBookMark
                      ? Center(child: Icon(Icons.bookmark_border_outlined, color: Colors.white.withOpacity(0.70), size: 30))
                      : Center(child: Icon(Icons.bookmark, color: Colors.orange.withOpacity(0.70), size: 30)),
                  // color: Colors.black.withOpacity(0.4),
                  splashRadius: 25,
                ),
              ),
