...
List<NotificationModel> notificationItem() {
  ...
  mList.add(NotificationModel("HouseHold", "now", ProKitShortText));
  mList.add(NotificationModel("Grocery", "4 min ago", ProKitShortText));
  mList.add(NotificationModel("Chilled", "30 min ago", ProKitShortText));
  return mList;
}
