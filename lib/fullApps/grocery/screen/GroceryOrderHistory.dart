...
class _GroceryOrderHistoryScreenState extends State<GroceryOrderHistoryScreen> {
  List<Compleated> listCompleted = compleated;

  @override
  Widget build(BuildContext context) {
    final completed = ListView.builder(
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(listCompleted[index].orderDate, style: boldTextStyle(size: 18)).paddingOnly(bottom: 16),
                          Text(
                            grocery_subtotal + ' ' + grocery_currency + ' ' + listCompleted[index].orderAmount,
                            style: primaryTextStyle(),
                          ),
                          4.height,
                          Text(grocery_totalItems + ': ' + listCompleted[index].totelItem, style: secondaryTextStyle())
                        ],
      ...
      body: SafeArea(
        child: DefaultTabController(
          ...
          child: Scaffold(
            ...
            body: TabBarView(
              children: <Widget>[completed, completed, completed],
            ),
          ),
        ),
      ),
