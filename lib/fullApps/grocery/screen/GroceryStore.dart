...
import 'package:access_maketicket/fullApps/grocery/utils/GroceryDataGenerator.dart';
import 'package:access_maketicket/fullApps/grocery/utils/snapping_sheet.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SnappingSheet(
        ...
        sheetAbove: SnappingSheetContent(child: Category()),
      ),
    );
  }
}
