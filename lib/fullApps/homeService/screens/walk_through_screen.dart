                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(color: white, fontWeight: FontWeight.bold, fontSize: 28),
                            ),
                            Space(16),
                            Text(
                        ...
                        Visibility(
                          ...
                          child: ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              backgroundColor: appStore.isDarkModeOn ? Colors.black : white,
                        ...
                        Visibility(
                          ...
                          child: Align(
                            ...
                            child: IconButton(
                              ...
                              icon: Icon(Icons.arrow_circle_right_rounded, color: white, size: 50),
