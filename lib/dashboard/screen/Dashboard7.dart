...
import 'package:access_maketicket/dashboard/utils/Db7BottomNavigationBar.dart';
...
class Dashboard7 extends StatefulWidget {
  static String tag = '/medical';

  final bool isDirect;

  Dashboard7({this.isDirect = false});
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      16.width,
                      Text(db7_lbl_my_medical, style: boldTextStyle(size: 24)).expand(),
