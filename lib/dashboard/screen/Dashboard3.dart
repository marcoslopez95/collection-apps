...
class Dashboard3 extends StatefulWidget {
  static String tag = '/furniture';

  final bool isDirect;

  Dashboard3({this.isDirect = false});
...
class Db3Slider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        Container(width: context.width(), child: Image.asset(img, fit: BoxFit.cover)),
        Align(
