...
class Dashboard2 extends StatefulWidget {
  static String tag = '/e_commerce';

  final bool isDirect;

  Dashboard2({this.isDirect = false});
                  ...
                  children: <Widget>[
                    ...
                    ScrollConfiguration(
                      ...
                      child: HorizontalList(
                        ...
                        itemBuilder: (_, i) {
                          return Db2Category(mListings[i], i);
                        },
                      ),
                    ),
                    Text(
                    ...
                    ScrollConfiguration(
                      ...
                      child: HorizontalList(
                        ...
                        itemBuilder: (_, i) {
                          return Db2Product(mListings1[i], i);
                        },
                      ),
                    ),
                    8.height,
                    ...
                    ScrollConfiguration(
                      ...
                      child: HorizontalList(
                        ...
                        itemCount: mListings.length,
                        itemBuilder: (_, i) {
                          return Db2Product(mListings[i], i);
                        },
                      ),
                    ),
                    16.height,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ClipRRect(
            borderRadius: BorderRadius.circular(12.0),
            child: commonCachedNetworkImage(model.img, fit: BoxFit.cover, height: 170, width: context.width()),
          ),
          SizedBox(height: 4),
          Padding(
