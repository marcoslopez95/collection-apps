...
import 'package:access_maketicket/dashboard/analytics/components/last_seen_drop_down_component.dart';
import 'package:access_maketicket/dashboard/analytics/components/page_analytics_list_component.dart';
import 'package:access_maketicket/dashboard/analytics/components/page_drop_down_component.dart';
import 'package:access_maketicket/dashboard/analytics/components/spline_chart_component.dart';
...
class AnalyticsDashboardFragment extends StatefulWidget {
  ...
  AnalyticsDashboardFragment({this.isDirect = false});
            ...
            Wrap(
              ...
              children: List.generate(setPageAnalyticsInfo.length, (index) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(color: context.cardColor, borderRadius: radius(DEFAULT_ANALYTICS_RADIUS)),
                  child: PageAnalyticsListComponent(data: pageAnalyticData).paddingSymmetric(horizontal: 16),
                );
              }),
            ),
            30.height,
