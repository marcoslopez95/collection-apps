...
class SVCHomePage extends StatefulWidget {
  static String tag = '/show_case_view_home_page';

  final bool isDirect;

  SVCHomePage({this.isDirect = false});
...
//   Global Variable to maintain the sequence of the ShowCaseView.
  ...
  BoxDecoration boxDecoration(
    ...
    return BoxDecoration(
      ...
      boxShadow: [
        BoxShadow(color: radiusColor, blurRadius: blurRadius, spreadRadius: spreadRadius),
      ],
  ...
  void init() {
    afterBuildCreated(() {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        Future.delayed(Duration(milliseconds: 200), () => ShowCaseWidget.of(getContext).startShowCase([_one, _two, _three]));
      });
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ShowCaseWidget(
      builder: (context) => Scaffold(
        appBar: appBar(context, 'Show Case View', isDashboard: widget.isDirect),
        body: Container(
          child: Container(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 25),
                  Text('Hi, John', style: boldTextStyle()),
                  SizedBox(height: 10),
                  Text('You have 3 exams pending', style: TextStyle(fontSize: 14, color: Color(0xFF757575))),
                  SizedBox(height: 15),
                  Container(
                    height: 250,
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Expanded(
                        child: Text('Lessons', style: boldTextStyle(size: 16)),
                      ),
                      InkWell(
                        child: Showcase(
                  ...
                  SizedBox(height: 5),
                  Text('Senior High School - 12th Grade', style: secondaryTextStyle(size: 14)),
                  SizedBox(height: 5),
                  Container(
                    height: 150,
                    child: ListView.builder(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: Text(lessons[index].title!, style: primaryTextStyle(size: 14)),
                                  )
                                ],
                              ),
                            ),
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Expanded(
                        child: Text('Live Video', style: boldTextStyle()),
                      ),
                      Text('SEE ALL', style: boldTextStyle(color: sdPrimaryColor, size: 14)),
                    ],
                  ),
                  SizedBox(height: 20),
                  Container(
