...
import 'package:access_maketicket/main/utils/shimmer/shimmer.dart';

class SHomePage extends StatefulWidget {
  static String tag = '/shimmer_home_page';

  final bool isDirect;

  SHomePage({this.isDirect = false});
...
class _SHomePageState extends State<SHomePage> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: appBar(context, 'Shimmer',isDashboard: widget.isDirect),
