...
class VideoPickerScreen extends StatefulWidget {
  static String tag = '/video_picker';

  final bool isDirect;

  VideoPickerScreen({this.isDirect = false});
...
class VideoPickerScreenState extends State<VideoPickerScreen> {
  ...
  Future<File> pickVideoFromGallery({bool isCamera = true}) async {
  ...
  Future getVideo() async {
    pickVideo = await pickVideoFromGallery(isCamera: false);
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: appBar(context, "Video Picker", isDashboard: widget.isDirect),
