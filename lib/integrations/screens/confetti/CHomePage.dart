...
import 'package:access_maketicket/main/utils/confetti/confetti.dart';

class CHomePage extends StatefulWidget {
  static String tag = '/confetti_home_page';
  final bool isDirect;

  CHomePage({this.isDirect = false});
...
class _CHomePageState extends State<CHomePage> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: appBar(context, 'Confetti', isDashboard: widget.isDirect),
        body: Stack(
          children: <Widget>[
            ...
            Container(
              alignment: Alignment.bottomCenter,
              margin: EdgeInsets.only(bottom: 150, left: 15, right: 15,top: 16),
              child: Row(
