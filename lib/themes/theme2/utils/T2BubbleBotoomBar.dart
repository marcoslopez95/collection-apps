...
class _BottomNavigationTile extends StatelessWidget {
  const _BottomNavigationTile(this.item, this.opacity, this.animation, this.iconSize, {this.onTap, this.flex, this.selected = false, this.indexLabel, this.ink = false, this.inkColor, this.colorTween});
...
BubbleBottomBarItem tab(IconData iconData, String tabName) {
  return BubbleBottomBarItem(backgroundColor: t2_colorPrimary, icon: Icon(iconData, color: appStore.iconColor), activeIcon: Icon(iconData, color: t2_colorPrimary), title: Text(tabName, style: primaryTextStyle()));
}
