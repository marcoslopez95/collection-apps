...
class T6SignIn extends StatefulWidget {
  static String tag = '/fitness_sign_in';
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: CachedNetworkImage(placeholder: placeholderWidgetFn() as Widget Function(BuildContext, String)?, imageUrl: t6_ic_logo, width: width),
                ),
                SizedBox(
                  height: 30,
                ),
