              ...
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: Column(
                        children: <Widget>[text(mContactList[index].name, textColor: appStore.textPrimaryColor, fontSize: textSizeMedium, fontFamily: fontMedium), text(mContactList[index].contactno, fontSize: textSizeMedium)],
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.start,
                      ),
                    )
