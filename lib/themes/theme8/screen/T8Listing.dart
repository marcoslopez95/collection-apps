...
import 'package:access_maketicket/themes/theme8/utils/T8DataGenerator.dart';
...
class T8Listing extends StatefulWidget {
  static String tag = '/listing_eight';

  final bool isDirect;

  T8Listing({this.isDirect = false});
...
class T8ListingState extends State<T8Listing> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: appBar(context, t8_lbl_biology_basics, isDashboard: widget.isDirect),
      body: Column(
        children: <Widget>[
          Expanded(
