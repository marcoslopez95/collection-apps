...
import 'package:access_maketicket/themes/theme4/utils/T4Widgets.dart';
import 'package:access_maketicket/themes/theme4/utils/widgets/T4BottomNavigationBar.dart';
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: StaggeredGrid.count(
                          ...
                          children: mListings.map((mListingsData) {
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ClipRRect(
                                    child: CachedNetworkImage(
                                      placeholder: placeholderWidgetFn() as Widget Function(BuildContext, String)?,
                                      imageUrl: mListingsData.image,
                                    ),
                                    borderRadius: BorderRadius.circular(4),
                                  ),
                                  text(mListingsData.name, textColor: appStore.textPrimaryColor, fontSize: textSizeLargeMedium, fontFamily: fontBold),
                                  text(mListingsData.info, fontSize: textSizeMedium, textColor: appStore.textSecondaryColor),
                                ],
                              ),
                            );
                          }).toList(),
