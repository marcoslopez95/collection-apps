                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("${data.noOfFiles} Files", style: Theme.of(context).textTheme.bodySmall!.copyWith(color: Colors.white70)),
                          Text(data.totalSize.validate(), style: Theme.of(context).textTheme.bodySmall!.copyWith(color: Colors.white)),
                        ],
                      )
                    ],
                  ),
