              ...
              Container(
                child: Column(
                  ...
                  children: [
                    ...
                    24.height,
                    Text(
                      "ProKit – Biggest Flutter UI kit is the ultimate library of Flutter UI templates combined into a "
                      "high-quality Flutter UI kit for Android/iOS developers.",
                      style: secondaryTextStyle(size: 16),
                    ),
                    24.height,
                    OutlinedButton(
                      ...
                      style: OutlinedButton.styleFrom(
                        foregroundColor: Colors.transparent, side: BorderSide(color: portfolio3PrimaryColor),
              ...
              Container(
                child: Column(
                  ...
                  children: [
                    ...
                    24.height,
                    Text(
                      "ProKit – Biggest Flutter UI kit is the ultimate library of Flutter UI templates combined into a high-quality Flutter UI kit for "
                      "Android/iOS developers. The collection consists of UI elements and styles based on Material Design Guidelines. ",
                      style: secondaryTextStyle(size: 16),
                    ),
                    24.height,
                    OutlinedButton(
