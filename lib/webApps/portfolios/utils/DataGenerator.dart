import 'package:access_maketicket/webApps/portfolios/models/Portfolio1SkillModel.dart';
import 'package:access_maketicket/webApps/portfolios/models/Portfolio2ServiceModel.dart';
...
List<Portfolio1ExperiencesModel> getExperienceDetail() {
  ...
  model1.subTitle = "ProKit – Biggest Flutter UI kit is the ultimate library of Flutter UI "
  ...
  model2.subTitle = "ProKit – Biggest Flutter UI kit is the ultimate library of Flutter UI "
      "templates combined into a high-quality Flutter UI kit for Android/iOS developers";
  ...
  model3.subTitle = "ProKit – Biggest Flutter UI kit is the ultimate library of Flutter UI "
      "templates combined into a high-quality Flutter UI kit for Android/iOS developers";
...
List<GuideLinesModel> getGuideLineDetail1() {
  ...
  model1.detail = "ProKit – Biggest Flutter UI kit is the ultimate library of Flutter UI "
      "templates combined into a high-quality Flutter UI kit for Android/iOS developers";
  model1.img = p3User1;
  ...
  model2.detail = "ProKit – Biggest Flutter UI kit is the ultimate library of Flutter UI "
      "templates combined into a high-quality Flutter UI kit for Android/iOS developers";
  model2.img = p3User3;
  ...
  model3.detail = "ProKit – Biggest Flutter UI kit is the ultimate library of Flutter UI "
      "templates combined into a high-quality Flutter UI kit for Android/iOS developers";
  model3.img = p3User2;
...
List<GuideLinesModel> getClientHappyList() {
  ...
  model1.detail = "ProKit – Biggest Flutter UI kit is the ultimate library of Flutter UI templates "
  ...
  model2.detail = "ProKit – Biggest Flutter UI kit is the ultimate library of Flutter UI templates "
      "combined into a high-quality Flutter UI kit for Android/iOS developers. ";
  model2.img = p3User2;
  list.add(model2);
  ...
  model3.detail = "ProKit – Biggest Flutter UI kit is the ultimate library of Flutter UI templates "
      "combined into a high-quality Flutter UI kit for Android/iOS developers. ";
  model3.img = p3User3;
  list.add(model3);
