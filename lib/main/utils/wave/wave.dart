...
class _CustomWavePainter extends CustomPainter {
  ...
  _CustomWavePainter({this.color, this.colorMode, this.gradient, this.gradientBegin, this.gradientEnd, this.blur, this.heightPercentange, this.waveFrequency, this.wavePhaseValue, this.waveAmplitude, Listenable? repaint}) : super(repaint: repaint);
  ...
  _setPaths(double viewCenterY, Size size, Canvas canvas) {
    ...
    if (_layer.gradient != null) {
      ...
      _paint.shader = LinearGradient(begin: gradientBegin == null ? Alignment.bottomCenter : gradientBegin!, end: gradientEnd == null ? Alignment.topCenter : gradientEnd!, colors: _layer.gradient!).createShader(rect);
    }
    if (_layer.blur != null) {
