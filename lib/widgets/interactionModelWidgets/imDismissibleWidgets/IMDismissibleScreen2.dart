...
class IMDismissibleScreen2 extends StatefulWidget {
  static String tag = '/dismissible_screen2';

  final bool isDirect;

  IMDismissibleScreen2({this.isDirect = false});
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: appBar(context, 'Dismissible with One Side', isDashboard: widget.isDirect),
