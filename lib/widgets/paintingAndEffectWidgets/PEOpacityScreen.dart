...
class PEOpacityScreen extends StatefulWidget {
  static String tag = '/opacity_screen';
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Expanded(
                  ...
                  child: Opacity(
                    opacity: 0.2,
                    child: FadeInImage(height: 100, width: 100, placeholder: Image.asset('images/widgets/paintingAndEffectWidgets/opacity/opactiy1.png').image, image: Image.asset('images/widgets/paintingAndEffectWidgets/opacity/opactiy1.png').image),
                  ),
                ),
            ...
            Row(
              ...
              children: [
                Expanded(
                  flex: 1,
                  child: CachedNetworkImage(placeholder: placeholderWidgetFn() as Widget Function(BuildContext, String)?, imageUrl: 'https://images.unsplash.com/photo-1487035242901-d419a42d17af?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80'),
                ),
                10.width,
                Expanded(
                  flex: 1,
                  child: ColorFiltered(
                    ...
                    child:
                        CachedNetworkImage(placeholder: placeholderWidgetFn() as Widget Function(BuildContext, String)?, imageUrl: 'https://images.unsplash.com/photo-1487035242901-d419a42d17af?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80'),
                  ),
                ),
              ],
            ).paddingBottom(20)
