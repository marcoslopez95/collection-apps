...
class CWPickerScreen extends StatefulWidget {
  static String tag = '/picker_screen';

  final bool isDirect;

  CWPickerScreen({this.isDirect = false});
...
class CWPickerScreenState extends State<CWPickerScreen> {
  ...
  List countryName = ["Afghanistan", "Albania", "Algeria", "Andorra", "Angola", "Antigua and Barbuda", "Argentina", "Armenia", "Bangladesh", "Brazil", "Colombia", "Denmark", "Estonia", "France", "Guinea-Bissau", "Holy See", "India", "Japan"];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBar(context, 'Cupertino Picker', isDashboard: widget.isDirect),
      body: SafeArea(
