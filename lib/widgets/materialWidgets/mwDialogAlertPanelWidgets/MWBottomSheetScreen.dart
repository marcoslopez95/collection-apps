...
class MWBottomSheetScreen extends StatefulWidget {
  static String tag = '/bottom_sheet_screen';

  final bool isDirect;

  MWBottomSheetScreen({this.isDirect = false});
...
class MWBottomSheetScreenState extends State<MWBottomSheetScreen> {
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                16.height,
                Text(ProKitLongText, style: secondaryTextStyle(color: appStore.textSecondaryColor)),
                8.height,
              ],
            ),
          );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: context.scaffoldBackgroundColor,
      appBar: appBar(context, 'Bottom Sheet', isDashboard: widget.isDirect),
