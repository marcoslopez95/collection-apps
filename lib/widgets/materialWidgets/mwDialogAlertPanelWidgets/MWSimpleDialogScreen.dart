...
class MWSimpleDialogScreen extends StatefulWidget {
  static String tag = '/simple_dialog_screen';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text(ProKitShortText, style: secondaryTextStyle(color: appStore.textSecondaryColor)),
            ),
            30.height,
          ],
        ),
...
class SimpleDialogExample extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SimpleDialog(
      ...
      children: [
        Text(ProKitShortText, style: primaryTextStyle()),
      ],
    );
  }
}
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            30.height,
            Padding(padding: const EdgeInsets.only(left: 16, right: 16), child: Text("Please check your internet connection and try again.", style: secondaryTextStyle())),
            16.height,
            GestureDetector(
              onTap: () {
